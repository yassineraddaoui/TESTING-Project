...
import { getFeedbackByBookId } from '../fn/feedback/get-feedback-by-book-id';
import { GetFeedbackByBookId$Params } from '../fn/feedback/get-feedback-by-book-id';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `getFeedbackByBookId()` */
  static readonly GetFeedbackByBookIdPath = '/feedbacks/book/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getFeedbackByBookId()` instead.
   *
   * This method doesn't expect any request body.
   */
  getFeedbackByBookId$Response(params: GetFeedbackByBookId$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponse>> {
    return getFeedbackByBookId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getFeedbackByBookId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getFeedbackByBookId(params: GetFeedbackByBookId$Params, context?: HttpContext): Observable<PageResponseFeedbackResponse> {
    return this.getFeedbackByBookId$Response(params, context).pipe(
