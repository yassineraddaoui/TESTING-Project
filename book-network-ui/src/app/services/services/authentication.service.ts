...
export class AuthenticationService extends BaseService {
  ...
  static readonly resentPath = '/auth/resent-CodeConfirmation'
  resentCodeConfirmation(email:string){
    return this.http.post(`${this.config.rootUrl}${(AuthenticationService.resentPath)}`,email);
